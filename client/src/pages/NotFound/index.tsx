...
const Notfound = () => {
  ...
  const bg: string = pegarTema === "light" ? "bg-light" : "bg-dark";
  return (
    <div
      className={
        "w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 font-dm transition-all duration-500 " +
        bg
      }
    >
